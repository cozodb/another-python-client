...
Expr: TypeAlias = Union[str | Param, Var, Const, InputParam, 'InputObject', 'InputList', 'OpApply']
...
class InputRelation:
    ...
    values: list[str | tuple[str, str] | tuple[str, str, str]] = field(default_factory=list)
...
Atom: TypeAlias = Expr | Cond | Bind | RuleApply | StoredRuleApply | StoredRuleNamedApply | ProximityApply | Conjunction | Disjunction | Negation | RawAtom
...
@dataclass
class InputProgram:
    rules: list[ConstantRule | InlineRule | FixedRule] = field(default_factory=list)
    limit: int | None = None
